...
public class ContinuingHttpServletRequestTest extends TestCase {
  ...
  private static final int DEFAULT_MAX_AGE = new Cookie("foo", "").getMaxAge();
  ...
  public void testReturnNullCookiesIfDelegateHasNoNull() {
    ...
    assertNull(new com.google.inject.jakarta.ContinuingHttpServletRequest(delegate).getCookies());
  ...
  public void testReturnDelegateCookies() {
    ...
    com.google.inject.jakarta.ContinuingHttpServletRequest continuingRequest = new com.google.inject.jakarta.ContinuingHttpServletRequest(delegate);
    ...
    com.google.inject.jakarta.ContinuingHttpServletRequest furtherContinuingRequest =
        new com.google.inject.jakarta.ContinuingHttpServletRequest(continuingRequest);
