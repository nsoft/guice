...
class ServletSpiVisitor extends DefaultBindingTargetVisitor<Object, Integer>
  ...
  ServletSpiVisitor(boolean forInjector) {
    ...
    builder.add(
        ...
        com.google.inject.jakarta.ManagedFilterPipeline.class,
        com.google.inject.jakarta.ManagedServletPipeline.class,
        com.google.inject.jakarta.FilterPipeline.class,
        ...
        Map.class,
        HttpServlet.class,
        com.google.inject.jakarta.InternalServletModule.BackwardsCompatibleServletContextProvider.class,
        GuiceFilter.class);
    if (forInjector) {
  ...
  static class Params {
    ...
    private final com.google.inject.jakarta.UriPatternType patternType;
