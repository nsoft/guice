...
public class UriPatternTypeTest extends TestCase {
  ...
  public void testMatches_servlet() {
    com.google.inject.jakarta.UriPatternMatcher pattern = UriPatternType.get(UriPatternType.SERVLET, "/foo/*");
  ...
  public void testMatches_regex() {
    com.google.inject.jakarta.UriPatternMatcher pattern = UriPatternType.get(UriPatternType.REGEX, "/.*/foo");
    assertFalse(pattern.matches("/foo/asdf"));
    assertFalse(pattern.matches("/foo/asdf?val=1"));
