...
public class ServletModuleTest extends TestCase {
  ...
  private static class Visitor extends DefaultBindingTargetVisitor<Object, Void>
    ...
    List<com.google.inject.jakarta.LinkedFilterBinding> linkedFilters = Lists.newArrayList();
    List<com.google.inject.jakarta.LinkedServletBinding> linkedServlets = Lists.newArrayList();
    List<com.google.inject.jakarta.InstanceFilterBinding> instanceFilters = Lists.newArrayList();
    List<com.google.inject.jakarta.InstanceServletBinding> instanceServlets = Lists.newArrayList();
