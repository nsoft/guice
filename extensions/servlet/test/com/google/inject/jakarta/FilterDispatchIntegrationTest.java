...
import static com.google.inject.jakarta.ServletTestUtils.newNoOpFilterChain;
...
public class FilterDispatchIntegrationTest extends TestCase {
  ...
  private void runRequestForPath(com.google.inject.jakarta.FilterPipeline pipeline, String value, boolean matches)
      throws IOException, ServletException {
  ...
  public final void testFilterExceptionPrunesStack() throws Exception {
    ...
    HttpServletRequest request = newFakeHttpServletRequest();
    com.google.inject.jakarta.FilterPipeline pipeline = injector.getInstance(com.google.inject.jakarta.FilterPipeline.class);
    pipeline.initPipeline(null);
    try {
      ...
      for (StackTraceElement element : ex.getStackTrace()) {
        ...
        assertTrue(
            "was: " + element,
            !className.equals(com.google.inject.jakarta.FilterChainInvocation.class.getName())
                && !className.equals(com.google.inject.jakarta.FilterDefinition.class.getName()));
      }
    }
  }
