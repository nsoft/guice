...
import static com.google.inject.jakarta.ManagedServletPipeline.REQUEST_DISPATCHER_REQUEST;
...
public class ServletPipelineRequestDispatcherTest extends TestCase {
  ...
  public final void testIncludeManagedServlet() throws IOException, ServletException {
    ...
    final com.google.inject.jakarta.ServletDefinition servletDefinition =
        new com.google.inject.jakarta.ServletDefinition(
    ...
    final Key<com.google.inject.jakarta.ServletDefinition> servetDefsKey = Key.get(TypeLiteral.get(com.google.inject.jakarta.ServletDefinition.class));

    Binding<com.google.inject.jakarta.ServletDefinition> mockBinding = createMock(Binding.class);
    expect(injector.findBindingsByType(eq(servetDefsKey.getTypeLiteral())))
        .andReturn(ImmutableList.<Binding<com.google.inject.jakarta.ServletDefinition>>of(mockBinding));
    Provider<com.google.inject.jakarta.ServletDefinition> bindingProvider = Providers.of(servletDefinition);
    ...
    final RequestDispatcher dispatcher =
        new com.google.inject.jakarta.ManagedServletPipeline(injector).getRequestDispatcher(pattern);
  ...
  public final void testWrappedRequestUriAndUrlConsistency() {
    ...
    replay(mockRequest);
    HttpServletRequest wrappedRequest = com.google.inject.jakarta.ManagedServletPipeline.wrapRequest(mockRequest, "/new-uri");
